...
public class Factorial {
    ...
    public static void method(int num){
        if (num > 0) {
            System.out.println("用递归求" + num + "的阶乘-结果：" + recursion(num));
        } else if (num == 0) {
            System.out.println("用递归求0的阶乘-结果：1");
        } else if (num < 0) {
    ...
    //do-while
        public static void FactorialDoWhile(int num) {
            if (num > 0) {
                ...
                System.out.println("用for循环语句求" + num + "的阶乘-结果：" + result);
            } else if (num == 0) {
        ...
        public static void FactorialWhile(int num) {
            if (num > 0) {
                ...
                System.out.println("用while循环语句求" + num + "的阶乘-结果：" + result);
            } else if (num == 0) {
                System.out.println("用while循环语句求0的阶乘-结果：1");
            } else if (num < 0) {
                System.out.println("负数没有阶乘");
        ...
        public static void FactorialFor(int num) {
            if (num > 0) {
                ...
                System.out.println("用for循环语句求" + num + "的阶乘-结果：" + sum);
            } else if (num == 0) {
                System.out.println("用for循环语句求" + num + "的阶乘-结果：1");
            } else {
                System.out.println("负数没有阶乘");
            }
        }
